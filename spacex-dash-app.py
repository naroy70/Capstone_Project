...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(
                                    ...
                                    value=[0, 10000]  # Set initial range to the full span
                                ),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        if not (0 in outcome_counts['class'].values):
            outcome_counts = outcome_counts.append({'class': 0, 'count': 0}, ignore_index=True)
        if not (1 in outcome_counts['class'].values):
            outcome_counts = outcome_counts.append({'class': 1, 'count': 0}, ignore_index=True)
...
def update_scatter_chart(entered_site, payload_range):
    ...
    # Check if the user selected a specific site or all sites
    if entered_site == 'ALL':
        # Plot all sites
